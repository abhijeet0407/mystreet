        ...
        <section id="main">
            ...
            <section id="content">
                ...
                <div class="card">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="<?php echo url('/location') ?>"> 
                  <?php }else{

                  
                   ?>
                  <form class="form-horizontal" role="form" method="POST" action="<?php echo url('/location/'.$location->id) ?>"> 
