...
<?php include(base_path().'/resources/views/include/header.php') ?>    
        ...
        <section id="main">
            ...
            jQuery(document).ready(function($) {
            	$('a[data-table]').attr('data-table','vendor');
            });
                        ...
                        <div class="list-group lg-alt lg-even-black">
                            ...
                            <div rel="<?php echo $data->id; ?>" class="list-group-item media">
                                <div class="pull-right">
                                            ...
                                            <a data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit" href="/<?php echo $module.'/'.$data->user_id.'/'.'edit' ?>" class="btn btn-xs palette-Cyan btn-icon bg waves-effect waves-circle waves-float"><i class="zmdi zmdi-edit"></i></a>
                                            <a href="javascript:void(0)" rel="<?php echo $data->user_id; ?>" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Remove" data-table="" data-token="<?php echo csrf_token();  ?>" class="btn singleDelete btn-xs btn-danger m-l-10 btn-icon waves-effect waves-circle waves-float"><i class="zmdi zmdi-delete"></i></a>
                                ...
                                <div class="pull-left">
                                    <div data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Check this box to add this listing to bulk delete" class="avatar-char ac-check">
                                                ...
                                                <span class="acc-helper palette-Teal bg"><?php echo substr($data->name,0,1) ?></span>
                                            </div>
                                    
                                </div>

                                <div class="media-body">
                                    <div class="lgi-heading"><?php echo $data->name; ?></div>
                                   
                                     <ul class="lgi-attrs">
                                    
                                    	<li>Location: <?php echo $data->location->location; //$desired=$location->find($data->vendor->location_id); echo $desired['location']; ?></li>
