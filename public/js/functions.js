                ...
                //singledelete
                    $('body').on('click','.singleDelete',function(){
                        ...
                        function(){
                            ...
                            //console.log(APP_URL+'/'+bel+'/'+rel);
                          
                            common_delete_function(rel,bel,token);
                   ...
                   //bulkdelete
                    $('body').on('click','.bulkDelete',function(){
                        ...
                        swal({
                          title: "Are you sure?",
                          text: "You want to bulk delete all the checked entries!",
                          type: "warning",
                          showCancelButton: true,
                          confirmButtonColor: "#DD6B55",
                          confirmButtonText: "Yes, delete it!",
                        ...
                        function(){
                            ...
                            var checked_ids = $('input:checkbox:checked.acc-check').map(function () {
                             ...
                             $.each(checked_ids,function(index, el) {
                               // alert(el+bel+token);
                                   common_delete_function(el,bel,token) ;
                             });   
                   ...
                   function common_delete_function(rel,bel,token){
